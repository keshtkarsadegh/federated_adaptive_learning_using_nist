...
def plot_combined_model(json_path="global_clients_global_metrics.json",clients_metric_json_path="global_clients_all_outliers_metrics.json",save_path="global_clients_training_plot.png", font_size=5, dpi=200):
    """
...
if __name__ == "__main__":
    # Example usage:
    plot_combined_model(font_size=18)
